...
class DriverSerializer(serializers.ModelSerializer):
	...
	# 	"""
	# 		create the driver in the first step with 
	# 		only initial driver data

	# 		Request URL /api/quoteshell/<shell_id>/quotes/<quote_id>/drivers/
	# 		{
	# 		    "quote":1,
	# 		    "driver": {
	#                 "first_name": "fddddgg",
	...
	# 	quote = Quote.objects.get(id=driver_data['quote'])
	# 	pdb.set_trace()

	# 	driver = Driver.objects.create(quote=quote, **driver_data['driver'])
